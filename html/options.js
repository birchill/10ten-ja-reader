...
class Config {
    constructor() {
        ...
        this.DEFAULT_KEYS = this.DEFAULT_KEY_SETTINGS.reduce((defaultKeys, setting) => {
    ...
    set readingOnly(value) {
        if (typeof this._settings.readingOnly !== 'undefined' &&
    ...
    set popupStyle(value) {
        if (typeof this._settings.popupStyle !== 'undefined' &&
    ...
    get contextMenuEnable() {
        return (typeof this._settings.contextMenuEnable === 'undefined' ||
            this._settings.contextMenuEnable);
    }
    set contextMenuEnable(value) {
        if (typeof this._settings.contextMenuEnable !== 'undefined' &&
    ...
    set noTextHighlight(value) {
        if (typeof this._settings.noTextHighlight !== 'undefined' &&
    ...
    get showKanjiComponents() {
        return (typeof this._settings.showKanjiComponents === 'undefined' ||
