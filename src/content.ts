...
export class ContentHandler {
  ...
  async tryToUpdatePopup({
    ...
    const lookupParams = {
      ...
      targetProps: getTargetElementProps({
        target: eventElement,
  ...
  showPopup(options?: { copyState?: CopyState; copyType?: CopyType }) {
    ...
    // TODO: Set this based on whether or not the most recent mousemove event
    // was generated by the puck, not simply on whether or not the puck is
    // available.
