...
describe('getTextAtPoint', () => {
  ...
  describe('hit-testing and geometry', () => {
    ...
    it('does NOT find a range in a div when the point is a long way away due to preformatted line wrapping', () => {
      // Arrange
      ...
      const bbox = getBboxForOffset(textNode, '或日の暮方の事である。'.length);
