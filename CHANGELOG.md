...
- Added Anki integration via AnkiConnect. You can now add vocabulary cards directly from the popup to your Anki decks. Configure your deck, note type, and field mapping in the extension settings.
